    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center px-6 py-12">
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
        ...
        <form className="grid gap-4" onSubmit={handleEmailSignup}>
          ...
          <button type="button" onClick={handleGoogleSignup} disabled={pending || !isFirebaseEnabled} className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-600 text-white transition-opacity transition-shadow duration-200 hover:opacity-90 hover:shadow-sm active:scale-[.99] disabled:opacity-60">
